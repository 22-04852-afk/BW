...
<body>
    ...
    <div id="gearLoaderContainer" style="display: none;">
        <div style="
            ...
            gap: 20px;
        ">
            <dotlottie-wc src="https://lottie.host/553405d0-4407-4c03-a973-898c31ac845a/oOYaRfJe97.lottie" style="width: 440px; height: 200px; object-fit: contain;" autoplay loop></dotlottie-wc>
            <div style="
                color: #6B21FF;
                font-weight: 700;
                font-size: 18px;
                ...
                <table class="inventory-table">
                    ...
                    <tbody id="inventory-tbody">
                        ...
                        <?php foreach ($items as $index => $item): 
                            ...
                            if ($stock <= 5) {
                                $statusBadge = '<span style="background: #ff6b6b; color: #fff; padding: 3px 8px; border-radius: 12px; font-size: 10px; font-weight: 600;">🔴 Critical</span>';
                                $statusClass = 'stock-low';
                            } elseif ($stock > 5 && $stock <= 20) {
                                $statusBadge = '<span style="background: #ffa500; color: #fff; padding: 3px 8px; border-radius: 12px; font-size: 10px; font-weight: 600;">🟠 Low</span>';
                                $statusClass = 'stock-low';
                            } elseif ($stock > 20 && $stock <= 100) {
                                $statusBadge = '<span style="background: #4a90e2; color: #fff; padding: 3px 8px; border-radius: 12px; font-size: 10px; font-weight: 600;">🔵 Adequate</span>';
                                $statusClass = 'stock-good';
                            } else {
                                $statusBadge = '<span style="background: #2ecc71; color: #fff; padding: 3px 8px; border-radius: 12px; font-size: 10px; font-weight: 600;">🟢 High</span>';
                                $statusClass = 'stock-good';
                            }
                        ?>
